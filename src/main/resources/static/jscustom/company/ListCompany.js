                ...
                $('#tb_Company').bootstrapTable({
                    ...
                    columns: [{
                        ...
                        formatter: function indexFormatter(value, row, index){
                            var newvalue="";
                            if(value == "运营良好"){newvalue= '<span class="badge badge-success">'+value+'</span>';}
                            else if(value == "迟早倒闭"){newvalue= '<span class="badge badge-warning">'+value+'</span>';}
